...
const configPaths_1 = require("../src/configPaths");
describe('config-paths', () => {
    describe('default', () => {
        it('should return config path', () => {
            ...
            const actual = configPaths_1.configPaths(process).defaultConfig;
    ...
    describe('ENV:NODE_ENV', () => {
        it('should return actual config path', () => {
            ...
            const actual = configPaths_1.configPaths(process).envConfig;
    ...
    describe('DEPLOYMENT', () => {
        it('should return actual config path', () => {
            ...
            const actual = configPaths_1.configPaths(process).deploymentConfig;
    ...
    describe('USER', () => {
        it('should return actual config path', () => {
            ...
            const actual = configPaths_1.configPaths(process).userConfig;
    ...
    describe('ENV:NODE_CONFIG_DIR', () => {
        it('should set base config dir', () => {
            ...
            const actual = configPaths_1.configPaths(process);
            const expected = {
